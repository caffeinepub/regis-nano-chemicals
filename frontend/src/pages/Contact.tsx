  ...
  const contactDetails = [
    {
      icon: Mail,
      label: 'Email',
      value: 'info@regisnanochemicals.com',
      href: 'mailto:info@regisnanochemicals.com',
    },
    {
      icon: Phone,
      label: 'Phone',
                ...
                {submitted ? (
                  <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p className="text-brand-gray-text font-inter text-base max-w-sm">
                      Thank you for reaching out, <strong>{formData.name}</strong>! Our team will get back to you within 24 hours.
                    </p>
                    <button
                      onClick={() => {
                        setSubmitted(false);
                  ...
                  <>
                    <div className="flex items-center gap-3 mb-8">
                      ...
                      <div>
                        <h2 className="font-poppins font-800 text-brand-blue text-xl">Send Us a Message</h2>
                        <p className="text-brand-gray-text font-inter text-sm">We'll respond within 24 hours</p>
                      </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div className="space-y-1.5">
                          <Label htmlFor="name" className="font-poppins font-600 text-brand-black text-sm">
                        ...
                        <div className="space-y-1.5">
                          <Label htmlFor="email" className="font-poppins font-600 text-brand-black text-sm">
                          ...
                          />
                          {errors.email && (
                            <p className="text-red-500 text-xs font-inter">{errors.email}</p>
                          )}
                        </div>
                      </div>

                      <div className="space-y-1.5">
                        <Label htmlFor="phone" className="font-poppins font-600 text-brand-black text-sm">
                        ...
                        />
                        {errors.phone && (
                          <p className="text-red-500 text-xs font-inter">{errors.phone}</p>
                        )}
                      </div>

                      <div className="space-y-1.5">
                        <Label htmlFor="message" className="font-poppins font-600 text-brand-black text-sm">
                        ...
                        />
                        {errors.message && (
                          <p className="text-red-500 text-xs font-inter">{errors.message}</p>
                        )}
                      </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {contactDetails.map(({ icon: Icon, label, value, href }) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="font-inter font-500 text-brand-black text-sm">{value}</p>
                  </div>
                </a>
              ))}
              ...
              <div className="rounded-2xl overflow-hidden border border-brand-gray-mid shadow-card">
                <div
                  ...
                  style={{
                    background: 'linear-gradient(135deg, oklch(0.96 0 0) 0%, oklch(0.92 0.02 250) 100%)',
                  }}
                >
                  <div className="text-center">
                    <MapPin className="w-10 h-10 text-brand-blue mx-auto mb-2" />
                    <p className="font-poppins font-600 text-brand-blue text-sm">India</p>
                    <p className="text-brand-gray-text font-inter text-xs mt-1">Serving customers nationwide</p>
                  </div>
                  {/* Decorative grid lines */}
                  <div className="absolute inset-0 opacity-20 pointer-events-none"
                    style={{
                      backgroundImage: 'linear-gradient(oklch(0.38 0.15 250) 1px, transparent 1px), linear-gradient(90deg, oklch(0.38 0.15 250) 1px, transparent 1px)',
              ...
              <div className="p-5 bg-brand-blue rounded-2xl shadow-blue">
                <h3 className="font-poppins font-700 text-white text-sm mb-3">Business Hours</h3>
                <div className="space-y-1.5 text-sm font-inter">
                  <div className="flex justify-between text-white/80">
                    <span>Monday – Friday</span>
                    <span className="text-brand-yellow font-500">9:00 AM – 6:00 PM</span>
                  </div>
                  <div className="flex justify-between text-white/80">
                    <span>Saturday</span>
                    <span className="text-brand-yellow font-500">10:00 AM – 4:00 PM</span>
                  </div>
                  <div className="flex justify-between text-white/80">
                    <span>Sunday</span>
