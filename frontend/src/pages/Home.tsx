...
import { ArrowRight, ShieldCheck, Zap, Award, Truck } from 'lucide-react';
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(135deg, oklch(0.22 0.14 250) 0%, oklch(0.35 0.15 250) 55%, oklch(0.42 0.13 240) 100%)',
        }}
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-2xl">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-brand-yellow/20 border border-brand-yellow/30 mb-6 fade-in-delay-1">
              <Zap className="w-3.5 h-3.5 text-brand-yellow" fill="currentColor" />
              <span className="text-brand-yellow text-xs font-poppins font-600 tracking-wider uppercase">
                Nano Technology
              </span>
            </div>

            <h1 className="font-poppins font-900 text-white text-4xl sm:text-5xl lg:text-6xl leading-tight mb-4 fade-in-delay-2">
              REGIS NANO
              <br />
              <span className="text-brand-yellow">CHEMICALS</span>
            </h1>

            <p className="text-white/80 text-lg sm:text-xl font-inter font-400 leading-relaxed mb-8 fade-in-delay-3">
              Advanced Nano Technology for Superior Car Care
            </p>

            <p className="text-white/60 text-base font-inter leading-relaxed mb-10 max-w-lg fade-in-delay-4">
              Experience the future of car detailing with our scientifically formulated nano-technology products. 
              Protect, shine, and restore your vehicle to showroom perfection.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-brand-gray-text font-inter text-base leading-relaxed">
              REGIS NANO CHEMICALS is India's premier nano-technology car care brand. We combine cutting-edge 
              nano-particle science with professional-grade formulations to deliver products that protect, 
              restore, and enhance your vehicle's appearance like never before. Our commitment to innovation 
              and quality has made us the trusted choice for car enthusiasts and detailing professionals nationwide.
            </p>
          </div>
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-white/70 font-inter text-base mb-8 max-w-xl mx-auto">
              Explore our full range of nano-technology car care products and give your vehicle the treatment it deserves.
            </p>
